...
def contrubution_calculator(goal, current_savings, annual_rate, Months):
...
def Interest_calculator(current_savings, monthly_contribution, annual_rate, Month):
    month_rate = annual_rate / 12 / 100
    ...
    while True:
        try:
            ...
            #final goal minus current savings and how many month you wanted to invest to get a exact number of month needed to reach the goal
                ...
                Months = int(input("Enter the number of months you want to invest: "))
                contrubution_calculator(goal, current_savings, annual_rate, Months)
                ...
                Interest_calculator(current_savings, monthly_contribution, annual_rate, Month) 
            ...
            ("Invalid input. Please select a valid option from the menu.")
